...
<<<<<<< HEAD
                            <div className="MensajeContactosFundacion">
                                <h2>Contáctanos</h2>
                                <p>
                                    Únete a nuestra causa. Contáctanos hoy y descubre cómo puedes 
                                    contribuir al bienestar de nuestra comunidad. Cada esfuerzo 
                                    cuenta.
                                </p>
                            </div>
                            <div className="sectorDatosContactos">
                                <div className="cuadroSectorNumeros">
                                    <h5 className="subtitulosDeInfor">Teléfonos :</h5>
                                ...
                                <div className="cuadroSectorCorreo">
                        ...
                        <div className="googleMap">
                            <h5 className="subtitulosDeInforGoogleMap">Nos encontramos ubicados en la {locationAddress}</h5>
                            {isLoaded ? (
                                <GoogleMap
